    ...
    <body>
        ...
        <div class="container">
            ...
            <tbody>';
                ...
                echo '<a href="http://zend-emruhi/ldap/buscarUsuari.php">Buscar un altre Usuari</a> <br />';
                echo '<a href="http://zend-emruhi/ldap/menu.php">Tornar a Inici</a>';
            } else {
            ?>
                <div class="formldap">
                    <div class="form">
                        <form class="login-form" action="http://zend-emruhi/ldap/buscarUsuari.php" method="GET" autocomplete="off">
                            <h5>Cercar Usuari</h5>
