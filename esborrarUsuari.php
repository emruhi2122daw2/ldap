        ...
        <div class="container">
            ...
            if ($_POST['method'] == "DELETE") {
                if ($_POST['usr'] && $_POST['ou']) {
                    ...
                    echo '<a href="http://zend-emruhi/ldap/esborrarUsuari.php">Esborrar un altre Usuari</a> <br />';
            ...
            ?>
                <div class="formldap">
                    <div class="form">
                        <form class="login-form" action="http://zend-emruhi/ldap/esborrarUsuari.php" method="POST" autocomplete="off">
